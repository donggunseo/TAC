...
CUDA_VISIBLE_DEVICES=0 python3 attn_out_converter_cls.py --dataset_name banking77 --model_name llama3.2-1b --seed 40
CUDA_VISIBLE_DEVICES=0 python3 LoRA_tuning_cls.py --dataset_name banking77 
CUDA_VISIBLE_DEVICES=0 python3 attn_out_converter_cls.py --dataset_name banking77
